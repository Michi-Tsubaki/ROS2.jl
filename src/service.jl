...
mutable struct ServiceClient
    ...
    function ServiceClient(node::ROSNode, service_name::String, srv_type::String)
        ...
        return new(pyclient, srv_type_obj, node)
    end
end
...
mutable struct ServiceServer
    ...
    function ServiceServer(
        ...
        """
        pyserver, srv_type_obj =
            py"create_service"(node.pynode, service_name, srv_type, callback)
...
function wait_for_service(
    ...
    timeout_sec::Union{Nothing,Float64} = nothing,
)
